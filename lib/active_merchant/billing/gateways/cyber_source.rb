...
module ActiveMerchant # :nodoc:
  module Billing # :nodoc:
    ...
    class CyberSourceGateway < Gateway
      ...
      @@response_codes = {
        r100: "TRANSACTION SUCCESSFUL: You will receive an email confirmation shortly.",
        r101: "TRANSACTION NOT AUTHORIZED: Request is missing one or more required fields. Please re-enter your credit card information." ,
        r102: "TRANSACTION NOT AUTHORIZED: One or more fields contains invalid data. Please re-enter your credit card information.",
        ...
        r150: "TRANSACTION NOT AUTHORIZED: General failure. Please try the transaction again. If problem persists, please email helpdesk@elic.org.",
        r151: "TRANSACTION NOT AUTHORIZED: The request was received but a server time-out occurred. Please try the transaction again. If problem persists, please email helpdesk@elic.org.",
        r152: "TRANSACTION NOT AUTHORIZED: The request was received, but a service timed out. Please try the transaction again. If problem persists, please email helpdesk@elic.org.",
        r200: "TRANSACTION NOT AUTHORIZED: The authorization request was approved by the issuing bank but declined by the merchant because it did not pass the AVS check. Please contact your financial institution and try again later.",
        r201: "TRANSACTION NOT AUTHORIZED: The issuing bank has questions about the request. Please contact your financial institution and try again later.",
        r202: "CREDIT CARD NOT AUTHORIZED: The card expiration date is not valid. Please re-enter your credit card information.",
        r203: "CREDIT CARD NOT AUTHORIZED: The information provided is incorrect. Please re-enter your credit card information.",
        r204: "TRANSACTION NOT AUTHORIZED: The account provided has insufficient funds. Please try a different method of payment.",
        ...
        r230: "CREDIT CARD NOT AUTHORIZED: The authorization request was approved by the issuing bank but declined by our processor because it did not pass the card verification check. Please contact your financial institution and try again later.",
        r231: "TRANSACTION NOT AUTHORIZED: Invalid account number",
        r232: "CREDIT CARD NOT AUTHORIZED: The card type is not accepted by the payment processor. Please use your Visa, MasterCard, Discover Card or American Express card and try again.",
        r233: "TRANSACTION NOT AUTHORIZED: General decline by the processor.",
        r234: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: A problem exists with your CyberSource merchant configuration.",
        r235: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: The requested amount exceeds the originally authorized amount",
        r236: "TRANSACTION NOT AUTHORIZED: Processor failure. Please try the transaction again. If problem persists, please email helpdesk@elic.org.",
        r237: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: The authorization has already been reversed",
        r238: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: The authorization has already been captured",
        r239: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: The requested transaction amount must match the previous transaction amount",
        r240: "CREDIT CARD NOT AUTHORIZED: The card type sent is invalid or does not correlate with the credit card number",
        r241: "TRANSACTION NOT AUTHORIZED: The request ID is invalid. Please try the transaction again. If problem persists, please email helpdesk@elic.org.",
        r242: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: You requested a capture, but there is no corresponding, unused authorization record.",
        r243: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: The transaction has already been settled or reversed",
        r244: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: The bank account number failed the validation check",
        r246: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: The capture or credit is not voidable because the capture or credit information has already been submitted to your processor",
        r247: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: You requested a credit for a capture that was previously voided",
        r248: 'The boleto request was declined by your processor.',
        r250: "TRANSACTION NOT AUTHORIZED: The request was received, but a time-out occurred with the payment processor. Please try the transaction again. If problem persists, please email helpdesk@elic.org.",
        r251: 'The Pinless Debit card\'s use frequency or maximum amount per use has been exceeded.',
        r254: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: Your merchant account is prohibited from processing stand-alone refunds",
        r255: "TRANSACTION CANNOT BE PROCESSED: Please email helpdesk@elic.org and provide the following information: Your merchant account is not configured to process the service in the country you specified",
